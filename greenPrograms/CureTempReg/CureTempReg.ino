...
//Sleep Mode 
#define lowTempSleep 65
#define highTempSleep 75
...
void loop() 
{
  ...
  //LIGHT CHECK
  bool isLightOn = getLightStatus(lightPin1, lightPin2);

  //TEMP SENSOR 1
  
  //Get temp and hum from getters
  float tInF1 = getTemp(tempPin1);
  float h1 = getHum(tempPin1, tInF1);

  //TEMP SENSOR 2
  
  //Get temp and hum from getters
  float tInF2 = getTemp(tempPin2);
  float h2 = getHum(tempPin2, tInF2);
